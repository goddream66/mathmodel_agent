...
average_score = (sum(numbers) / len(numbers)) if numbers else 0.0
status = "ok" if numbers else "partial"
result = {
    "subproblem_title": subproblem["title"],
    "status": status,
    "method": analysis.get("chosen_method") or "baseline_evaluation_template",
    ...
    "result_summary": "Generated a baseline evaluation summary using detected indicator clues.",
    "evidence": [
