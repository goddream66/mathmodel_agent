...
context = {
  "problem_text": "Problem 1: forecast demand for the next 2 days.",
  "clarifications": [
  ...
  "subproblem": {
    "title": "Problem 1",
    "text": "forecast demand for the next 2 days.",
    "analysis": {
      "task_types": [
        "预测/拟合"
      ],
  ...
  "input_data": {
    "tables": [
      {
        "name": "forecast_alias_series",
        "source": "tests\\fixtures\\forecast_alias_series.csv",
        "kind": "table",
        "columns": [
          "qty_sold",
          "period"
