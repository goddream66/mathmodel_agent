...
context = {
  ...
  "all_subproblems": [
    ...
    {
      "title": "Problem 2",
      "text": "optimize profit under budget 100.",
      "analysis": {
        "task_types": [
          "优化/决策"
        ],
    ...
    "tables": [
      {
        ...
        "source": "tests\\fixtures\\forecast_series.csv",
        "kind": "table",
        "columns": [
          "day",
          "demand"
      ...
      },
      {
        ...
        "source": "tests\\fixtures\\optimization_items.csv",
        "kind": "table",
        "columns": [
          "item",
          "cost",
