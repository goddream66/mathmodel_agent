...
context = {
  "problem_text": "Problem 1: forecast demand with values 10 12 14 16.\nProblem 2: optimize cost under budget 100 with costs 40 25 30.\nProblem 3: find a path with distances 9 4 7.",
  "clarifications": [
  ...
  "subproblem": {
    "title": "Problem 2",
    "text": "optimize cost under budget 100 with costs 40 25 30.",
    "analysis": {
      "task_types": [
        "优化/决策"
      ],
  ...
  "all_subproblems": [
    {
      "title": "Problem 1",
      "text": "forecast demand with values 10 12 14 16.",
      "analysis": {
        "task_types": [
          "预测/拟合"
        ],
    ...
    {
      "title": "Problem 3",
      "text": "find a path with distances 9 4 7.",
      "analysis": {
        "task_types": [
          "路径/网络"
        ],
...
if candidate_costs and budget:
    ...
    if pulp is not None:
        ...
        problem += pulp.lpSum(candidate_costs[i] * variables[i] for i in range(len(candidate_costs)))
        ...
        for r in range(1, len(candidate_costs) + 1):
            for combo in itertools.combinations(candidate_costs, r):
