...
context = {
  "problem_text": "Problem 1: forecast demand for 7 days.\nProblem 2: optimize cost with budget 100.",
  "clarifications": [
  ...
  "subproblem": {
    "title": "Problem 2",
    "text": "optimize cost with budget 100.",
    "analysis": {
      "task_types": [
        "优化/决策"
      ],
  ...
  "all_subproblems": [
    {
      "title": "Problem 1",
      "text": "forecast demand for 7 days.",
      "analysis": {
        "task_types": [
          "预测/拟合"
        ],
